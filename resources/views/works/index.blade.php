                      ...
                      <div class="mokuhyou-box tw-flex tw-flex-col tw-flex-wrap tw-lg:py-6 tw-mb-4 tw-lg:w-1/2 tw-lg:pl-12 tw-lg:text-left tw-border border-solid  tw-w-[800px] tw-justify-center">
                          <div class="flex flex-col mb-10 items-center tw-text-left tw-pl-10">
                              <div class="tw-flex tw-justify-center tw-flex-col ">
                                  <h2 class="tw-text-gray-900 tw-title-font tw-font-medium tw-mt-2 " style="font-size: 20px">{{  $work->pulldown }}の目標<div style="font-size: 21p; margin-top:5px;">「 {{ $work->title }} 」</div></h2>
                                  <h2 class="tw-text-gray-900 tw-title-font tw-font-medium tw-mt-2 " style="font-size: 20px">詳細<div style="font-size: 17px">{!! nl2br(htmlspecialchars($work->contents)) !!} </div></h2>
