  ...
  <div class="container-box row justify-content-center tw-ml-40">
      <div class="col-md-10 work-list">
          <div class="card text-center">
              ...
              <div class="card-header tw-text-left tw-bg-red-100" style="font-size: 20px">
                ユーザー： {{ $work->user->name }}
            </div>
              <div class="card-body tw-bg-blue-100" style="padding: 5px">
                  <div class="tw-container tw-mx-auto tw-flex tw-flex-wrap tw-justify-center tw-items-center ">
                      ...
                      <div class="tw-flex tw-flex-col tw-flex-wrap tw-lg:py-6 tw-mb-4 tw-lg:w-1/2 tw-lg:pl-12 tw-lg:text-left tw-border border-solid  tw-w-[800px] tw-h-[70px] tw-justify-center">
                          <div class="flex flex-col mb-10 items-center tw-text-left tw-pl-10">
                              <div class="tw-flex tw-justify-center tw-flex-col ">
                                  <h2 class="tw-text-gray-900 tw-title-font tw-font-medium tw-mt-2 " style="font-size: 20px">目標： {{ $work->title }} </h2>
                      ...
                      <div class="tw-flex tw-items-center tw-w-full tw-justify-end tw-gap-3">
                        <p class="tw-leading-relaxed tw-text-base " style="font-size: 20px">投稿日時 : {{ substr($work->created_at, 0, 10) }}</p>
                        <a href="{{ route('works.show', $work->id) }}" class="tw-text-indigo-500 tw-inline-flex tw-items-center tw-text-2xl">詳細
